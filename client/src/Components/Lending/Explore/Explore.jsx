            ...
            <div className="container conteiner-blue" id="explore">
                <div className="explore-flex">
                    ...
                    <div className="explore-block">
                        ...
                        <div className="explore-block-text">В современном обществе существует проблема профориентации, команда проекта пытается её решить! Мы подготовили профориентационный тест, который поможет определиться с наиболее подходящей для вас профессией и помочь в её освоении.</div>
                        <Link to="explore">
