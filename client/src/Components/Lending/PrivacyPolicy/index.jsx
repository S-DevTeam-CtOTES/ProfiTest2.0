    ...
    return (
        <>
            ...
            <div className="privacy__policy container">
                ...
                href="https://platforma-exe.ru">https://platforma-exe.ru</a>. <br/>
                ...
                href="https://platforma-exe.ru">https://platforma-exe.ru</a>.
                ...
                достижении этих целей, если иное не предусмотрено федеральным законом. <br/>
                ...
                Российской Федерации об исполнительном производстве. <br/>
                ...
                в соответствии с федеральным законом. <br/><br/>
                ...
                profitest.dev@gmail.com с пометкой «Актуализация персональных данных». <br/>
                ...
                profitest.dev@gmail.com с пометкой «Отзыв согласия на обработку персональных данных». <br/>
                ...
                числе указанных в настоящем пункте поставщиков услуг. <br/>
                ...
                выявление неправомерной обработки персональных данных. <br/><br/>
                ...
                обезличивание, блокирование, удаление и уничтожение персональных данных. <br/>
                9.2. Оператор осуществляет автоматизированную обработку персональных данных с получением и/или передачей
                полученной информации по информационно-телекоммуникационным сетям или без таковой. <br/> <br/>
                ...
                href="mailto:profitest.dev@gmail.com">profitest.dev@gmail.com</a>. <br/>
                ...
                href="https://thismywebsite.com/privacy/" target="_blank">https://thismywebsite.com/privacy/</a>.
            </div>
        </>
    )
}
